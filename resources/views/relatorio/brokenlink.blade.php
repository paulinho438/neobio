...
<h3 class="page-title pb-1 mb-3 border-bottom">Broken Link Checker</h3>
        ...
        <div class="input-group mb-3">
          <form action="/brokenlink" method="POST" style="display: flex; width:100%;">
            @csrf
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="p-0 align-middle text-nowrap">
                <a href="{{url('/brokenlink')}}/{{$item->id}}" title="View report" class="btn btn-secondary btn-sm px-1"><i class="fas fa-fw fa-chart-bar"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
