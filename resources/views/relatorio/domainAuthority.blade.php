...
@section('content')
      ...
      <h3 class="page-title pb-1 mb-3 border-bottom">Domain Authority</h3>

      <div class="input-group mb-3">
        <form action="/domainauthority" method="POST" style="display: flex; width:100%;">
          @csrf
          ...
          @foreach ($list as $item)
            <tr>
              ...
              <td class="p-0 align-middle text-nowrap">
                <a href="{{url('/domainauthority')}}/{{$item->id}}" title="View report" class="btn btn-secondary btn-sm px-1"><i class="fas fa-fw fa-chart-bar"></i></a>
              </td>
            </tr>
          @endforeach
        </tbody>
